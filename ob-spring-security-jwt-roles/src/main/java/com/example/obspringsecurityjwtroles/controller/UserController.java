...
public class UserController {
    ...
    public User saveUser(@RequestBody UserDto user){ //data transfer object
        // prueba a lanzar excepción customizada
        // throw new EmailAlreadyExistsException("Email ocupado");
        return userService.save(user); //notar que va a UserServiceImpl
    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'USER')") //cualquiera de los 2
